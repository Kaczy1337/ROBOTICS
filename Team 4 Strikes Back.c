...
#pragma config(Motor,  port3,           clawA,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           backRightLift, tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port5,           frontRightLift, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           backLeftLift,  tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           frontLeftLift, tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port8,           clawB,         tmotorVex393_MC29, openLoop)
...
task usercontrol()
{
  ...
  while (true)
  {
    //Right side of the robot is controlled by the right joystick, Y-axis
		...
		if(vexRT[Btn5U] == 1)
		{
			motor[backRightLift] = 127;
			motor[backLeftLift] = 127;
			motor[frontLeftLift] = 127;
			motor[frontRightLift] = 127;
		}
